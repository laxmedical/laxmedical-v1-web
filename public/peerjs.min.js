    ...
    uI5X: [
      function (require, module, exports) {
        ...
        function u(t) {
          var r = e.detectBrowser(t);
          if (
            (!t.RTCPeerConnection && t.webkitRTCPeerConnection && (t.RTCPeerConnection = t.webkitRTCPeerConnection), t.RTCPeerConnection)
          ) {
            r.version < 53 &&
              ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate'].forEach(function (e) {
                var r = t.RTCPeerConnection.prototype[e],
                  n = o({}, e, function () {
                    return (
                      (arguments[0] = new ('addIceCandidate' === e ? t.RTCIceCandidate : t.RTCSessionDescription)(arguments[0])),
                      r.apply(this, arguments)
                    );
                  });
                t.RTCPeerConnection.prototype[e] = n[e];
      ...
      function (require, module, exports) {
        ...
        (r.localCName = r.generateIdentifier()),
          ...
          (r.parseRtpParameters = function (e) {
            for (
              var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, n = r.splitLines(e)[0].split(' '), a = 3;
              a < n.length;
              a++
            ) {
              var s = n[a],
            ...
            o.length > 0 && o[0].length > 1 && o[0][0] === c && (t = o[0][1]),
              a.codecs.forEach(function (r) {
                if ('RTX' === r.name.toUpperCase() && r.parameters.apt) {
                  ...
                  c && t && (e.rtx = { ssrc: t }),
                    n.push(e),
                    s && (((e = JSON.parse(JSON.stringify(e))).fec = { ssrc: c, mechanism: i ? 'red+ulpfec' : 'red' }), n.push(e));
                }
              }),
    ...
    NJ2u: [
      function (require, module, exports) {
        ...
        function o(e, t) {
          ...
          return (
            (r.name = e),
            (r.code = { NotSupportedError: 9, InvalidStateError: 11, InvalidAccessError: 15, TypeError: void 0, OperationError: void 0 }[
              e
            ]),
            r
          );
                      ...
                      if ('sendrecv' === S || 'sendonly' === S) {
                        ...
                        C.rtpReceiver &&
                          ...
                          (C.associatedRemoteMediaStreams.forEach(function (e) {
                            ...
                            n &&
                              ((t = n), (r = e).removeTrack(t), r.dispatchEvent(new c.MediaStreamTrackEvent('removetrack', { track: t })));
                          }),
          ...
          (e.navigator.mediaDevices && 'getDisplayMedia' in e.navigator.mediaDevices) ||
            (e.navigator.mediaDevices &&
              (e.navigator.mediaDevices.getDisplayMedia = function (a) {
                ...
                return (
                  !0 === a.video ? (a.video = { mediaSource: i }) : (a.video.mediaSource = i), e.navigator.mediaDevices.getUserMedia(a)
                );
              }));
        }
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.shimGetDisplayMedia = e);
              ...
              (e.RTCPeerConnection.prototype.addTransceiver = function () {
                ...
                if (r) {
                  var { sender: o } = n,
                    i = o.getParameters();
                  'encodings' in i ||
                    ((i.encodings = e.sendEncodings), this.setParametersPromises.push(o.setParameters(i).catch(function () {})));
                }
                return n;
              });
          }
            ...
            if (
              ...
              (e.RTCPeerConnection.prototype.addStream = function (e) {
                ...
                (e.RTCPeerConnection.prototype.addTrack = function (e) {
                  var r = arguments[1];
                  return (
                    r && (this._localStreams ? this._localStreams.includes(r) || this._localStreams.push(r) : (this._localStreams = [r])),
                    t.apply(this, arguments)
                  );
                });
            }
                ...
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 7:
                        return (
                          (s = t.sent()), n.emitError(c.PeerErrorType.WebRTC, s), r.default.log('Failed to create answer, ', s), [3, 8]
                        );
                      case 8:
                        return [2];
                    }
                ...
                return n(this, void 0, Promise, function () {
                  ...
                  return t(this, function (t) {
                    switch (t.label) {
                      ...
                      case 3:
                        return (
                          (d = t.sent()), s.emitError(c.PeerErrorType.WebRTC, d), r.default.log('Failed to handleCandidate, ', d), [3, 4]
                        );
                      case 4:
                        return [2];
                    }
