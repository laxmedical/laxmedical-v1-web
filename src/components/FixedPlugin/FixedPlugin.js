...
// @mui/icons-material
import SettingIcon from "@mui/icons-material/SettingsTwoTone";
  ...
  return (
    ...
    >
      <div id="fixedPluginClasses" className={props.fixedClasses}>
        <IconButton onClick={handleClick} style={{color:'white'}} size="large">
          {!props.fixedClasses.includes('show')?  <SettingIcon/>: <CloseIcon/>}
        </IconButton>
